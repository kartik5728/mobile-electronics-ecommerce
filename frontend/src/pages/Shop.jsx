...
import { ShopProductsGridLayout, ShopProductsListLayout } from './../components/exports'
...
const Shop = () => {
  ...
  return (
    <div className='w-full'>
      ...
      <div>
        <div className='w-full h-full flex flex-row sm:px-8 xl:px-12'>
          <div className='hidden xl:flex flex-1 h-full bg-red-200'>left</div>
          <div className='flex-4 h-full bg-blue-300'>
            {
              layout === 'grid' ? (<ShopProductsGridLayout />) : layout === 'list' ? (<ShopProductsListLayout />) : <div>Error Occured</div>
            }
          </div>
        </div>
      </div>
